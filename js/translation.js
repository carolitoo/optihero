function translateEN() {
    document.getElementById('text-selection-character').innerHTML = 'SELECT YOUR OPTI.HERO';
...
function translateDE() {
    document.getElementById('text-selection-character').innerHTML = 'WÄHLE DEINEN OPTI.HERO';
